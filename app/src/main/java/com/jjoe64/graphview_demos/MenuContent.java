...
//        addItem(new MenuItem("1", "Hello world graph", HelloWorldFragment.class));
        addItem(new MenuItem("1", "Zooming and scrolling", ZoomingAndScrollingFragment.class));
        addItem(new MenuItem("2", "Realtime plotting", RealtimeFragment.class));
        addItem(new MenuItem("3", "Time and dates", TimeAndDatesFragment.class));
        addItem(new MenuItem("4", "Second scale and labels", SecondScaleAndLabelsFragment.class));
        addItem(new MenuItem("5", "Line graph", LineGraphFragment.class));
        addItem(new MenuItem("6", "Bar graph", BarGraphFragment.class));
        addItem(new MenuItem("7", "Points graph", PointsGraphFragment.class));
        addItem(new MenuItem("8", "On tap listener", TapListenerGraphFragment.class));
//        addItem(new MenuItem("9", "Styling examples", StylingExamplesFragment.class));
//        addItem(new MenuItem("10", "Other examples", OthersFragment.class));
    }
